...
def get_db_connection():
    # Conexión SSL optimizada para Aiven con PyMySQL
    connection = pymysql.connect(
        ...
        ssl={'ssl': {}},  # Requiere SSL para Aiven
        cursorclass=pymysql.cursors.DictCursor
    )
    
    # Crear la tabla automáticamente si no existe en Aiven
